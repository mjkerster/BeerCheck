...
var domHelper = function(){
	...
	function createList(el, listData){
		...
		for(var i = 0; i < listData.length; i++){
			...
			template = '<li class="beer-row pure-u-1"><div class="pure-u-1"><div class="beer-image pure-u-1-8"><img src="'+imageSrc+'"></div><div class="title-section pure-u-4-5"><span class="title pure-u-1">'+listData[i].nameDisplay+'</span><span>'+listData[i].style.name+' </span><span>ABV: '+listData[i].abv+'%</span></div></div><div class="beer-description pure-u-1"><p>'+listData[i].description+'</p></div></li>'
